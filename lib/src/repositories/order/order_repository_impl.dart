...
class OrderRepositoryImpl extends OrderRepository {
  ...
  Future<void> changeStatus(int id, OrderStatus status) async {
    try {
      ...
      log('Erro ao alterar o status do pedido para: ${status.acronym}', error: e, stackTrace: s);

      throw RepositoryException(message: 'Erro ao alterar o status do pedido para: ${status.acronym}');
    }
  }
